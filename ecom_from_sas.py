...
webs=pd.read_csv('190718-260718_sites.csv',encoding='1251', sep=';')
#%%
...
#%%      
    ...
    writer = pd.ExcelWriter('190718-260718_NEW.xlsx',options={'strings_to_urls': False})
    data.to_excel(writer,index=None)
    writer.close()
    ...
    writer = pd.ExcelWriter('190718-260718.xlsx',options={'strings_to_urls': False})
